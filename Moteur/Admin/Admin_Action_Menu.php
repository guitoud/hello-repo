  ...
  if($tab_var['btn']=="Ajouter"){
    ...
    if($STOP==0){
      ...
      if($total_ligne_rq_page_info!=0){
        ...
        ( `MENU_ID` , `NOM_MENU` , `ORDRE` ,`MENU_INFO` )
        VALUES ( NULL , '".$NOM_MENU_TXT."', '".$ORDRE_TXT."', '".$MENU_INFO_TXT."');";
...
$rq_menu_info="
SELECT `MENU_ID` , `NOM_MENU`, `ORDRE` ,`MENU_INFO` FROM `moteur_menu` WHERE `MENU_ID`='".$ID."'";
