   ...
   <div align="center">
    ...
    <table class="table_inc" cellspacing="1" cellpading="0">
      <tr align="center" class="titre">
        <td align="center" colspan="'.$colspan.'">&nbsp;[&nbsp;<a href="./index.php?ITEM=indicateur_menu">Retour</a>&nbsp;]&nbsp;-&nbsp;<a href="./indicateur/indicateur_synthese_sogeti_csv.php?ANNEE='.$ANNEE.'"><img src="./img/logo_excel.png" border="0"/></a>&nbsp;</td>
      </tr>
      <tr align="center" class="titre">
        <td align="center" colspan="'.$colspan.'"><b>&nbsp;Synth&egrave;se ODTI trait&eacute;es par Sogeti pour '.$ANNEE.'&nbsp;</b></td>
      </tr>
      <tr align="center" class="titre">
