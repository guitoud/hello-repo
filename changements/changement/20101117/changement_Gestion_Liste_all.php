...
<table class="table_inc">
  <tr align="center" class="titre">
    <td align="center" colspan="12"><h2>&nbsp;Liste de l\'ensemble des changements&nbsp;</h2>
  ...
  ';
     if($NB_ALL>$Var_max_resultat_page_limit){
     	$var_url="./index.php?ITEM=changement_Gestion_Liste_all&order=".$order."&date_limit=".$date_limit;
     	echo '
  <tr align="center" class="titre">
      ...
      if($total_ligne_rq_changement_info!=0){
        echo '
              <tr align="center" class="titre">
                ...
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=iddesc">&#9660;</a>
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=id">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Demandeur
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=demandeurdesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=demandeur">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Status
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=statusdesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=status">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Type de demande
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=typedesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=type">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Date&nbsp;D&eacute;but
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=debutdesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=debut">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Heure&nbsp;</BR>&nbsp;D&eacute;but&nbsp;</td>
                <td align="center">&nbsp;Date&nbsp;Fin
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&&date_limit='.$date_limit.'&order=findesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&date_limit='.$date_limit.'&order=fin">&#9650;</a>
                &nbsp;
                </td>
