...
<!-- structure des DIV -->	
	...
	<div id="div_tabbar_modif_serveur" style="width:600px; height:400px;margin:20px;border-width: 1px; border-style: solid; border-color:#8db6cd"></div>
	<div id="div_tabbar_modif_appli" style="width:600px; height:400px;margin:20px;border-width: 1px; border-style: solid; border-color:#8db6cd"></div>
	<div id="div_tabbar_modif_asso" style="width:600px; height:400px;margin:20px;border-width: 1px; border-style: solid; border-color:#8db6cd"></div>
	<div id="div_grid1_layout_b_vide" style="width:100%; height:100%;"><font face="verdana" size=1> -- Aucune fiche disponible  --</font></div>
