...
function calendar($date = '') {
	...
	if ($param['show_month'] == 1) {
		...
		if ($param['use_img'] ) {
			$output .= '<img src="./calendrier/mois.gif">';
		}
		if ( $param['day_mode'] == 1 ) {
	...
	if ($param['nav_link'] == 1) {
		...
		if ($param['use_img']) {
			$g 	= '<img src="./calendrier/g.gif" border="0">';
			$gg = '<img src="./calendrier/gg.gif" border="0">';
			$d 	= '<img src="./calendrier/d.gif" border="0">';
			$dd = '<img src="./calendrier/dd.gif" border="0">';
		}
		else {
			$g 	= '&lt;';
			$gg = '&lt;&lt;';
