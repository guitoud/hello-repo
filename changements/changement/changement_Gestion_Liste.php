...
<table class="table_inc">
  <tr align="center" class="titre">
    <td align="center" colspan="13"><h2>&nbsp;[&nbsp;<a href="./index.php?ITEM=changement_Calendrier&amp;m='.$mois.'&amp;y='.$annee.'">Calendrier</a>&nbsp;]&nbsp;-[&nbsp;<a href="#Bas_de_page">Fin</a>&nbsp;]&nbsp;</h2></td>
  </tr>';
...
//      echo $rq_changement_info.' - '.$total_ligne_rq_changement_info.'';
  ...
  if ($nbre_car < 50){
	...
	mysql_free_result($res_rq_info_detail);
            ...
            echo'
              <tr align="center" class="titre">
                <td align="center" colspan="13"><h2>&nbsp;Changement du '.$NomJour.' '.$jour.'/'.$mois.'/'.$annee.'&nbsp;</h2></td>
              </tr>';
            echo '
              <tr align="center" class="titre">
                ...
                <td align="center">Fiche</BR>Res</td>
        ...
        echo'
              <tr align="center" class="'.$class.'">
                ...
                <td align="center"><strike>&nbsp;'.substr(datebdd_nomjour($DATE_DEBUT),0,3).' '.$DATE_DEBUT.'&nbsp;</strike></td>
                <td align="center"><strike>&nbsp;'.$HEURE_DEBUT.'&nbsp;</strike></td>
                <td align="center"><strike>&nbsp;'.substr(datebdd_nomjour($DATE_FIN),0,3).' '.$DATE_FIN.'&nbsp;</strike></td>
                ...
                <td align="center"><strike>&nbsp;'.stripslashes($FicheRes).'&nbsp;</strike></td>
              ...
              <tr align="center" class="'.$class.'">
                ...
                <td align="center">&nbsp;'.substr(datebdd_nomjour($DATE_DEBUT),0,3).' '.$DATE_DEBUT.'&nbsp;</td>
                <td align="center">&nbsp;'.$HEURE_DEBUT.'&nbsp;</td>
                <td align="center">&nbsp;'.substr(datebdd_nomjour($DATE_FIN),0,3).' '.$DATE_FIN.'&nbsp;</td>
                <td align="center">&nbsp;'.$HEURE_FIN.'&nbsp;</td>
                <td align="center">&nbsp;'.stripslashes($LIB).'&nbsp;</td>
                <td align="center">&nbsp;'.stripslashes($FAR).'&nbsp;</td>
                <td align="center">&nbsp;'.stripslashes($FicheRes).'&nbsp;</td>
        ...
        mysql_free_result($res_rq_changement_info);
          ...
          if ($numLigne%2) { $class = "pair";}else {$class = "impair";}
           echo'<tr align="center" class="'.$class.'">
            <td align="center" colspan="13">&nbsp;Pas d\'information&nbsp;</td>
          </tr>';
        }
        if($nbinter!=0){
          if($nbinter<=1){
          ...
          echo '  
          <tr align="center" class="titre">
            <td align="center" colspan="13">Il y a '.$nbinter.' '.$nbinter_info.'.</td>
          </tr> 
          <tr align="center" >
         ...
         echo '  
          <tr align="center" class="titre">
            <td align="center" colspan="13">Il n\'y a pas d\'intervention.</td>
          </tr> 
          <tr align="center" >
            <td align="center" colspan="13">&nbsp;</td>
          </tr>';
      ...
      if($ligne > 0) {
		...
		echo '
		<tr align="center" class="titre">
 		  <td align="center" colspan="13"><h2>&nbsp;[&nbsp;<a href="#Haut_de_page">D&eacute;but</a>&nbsp;]&nbsp;</h2></td>
    </tr>
		</table>';
