...
if(isset($_GET['STATUS_ID'])){
  ...
  $STATUS_ID_SQL="AND `changement_status`.`CHANGEMENT_STATUS_ID`='".$STATUS_ID."'";
  $RETOUR='[&nbsp;<a href=./index.php?ITEM=changement_Gestion_Mail>Retour</a>&nbsp;]';
}else{
  $STATUS_ID_SQL='';
  $RETOUR='';
}
if(isset($_GET['DEMANDE_ID'])){
  ...
  $DEMANDE_ID_SQL="AND `changement_demande`.`CHANGEMENT_DEMANDE_ID`='".$DEMANDE_ID."'";
  $RETOUR='[&nbsp;<a href=./index.php?ITEM=changement_Gestion_Mail>Retour</a>&nbsp;]';
}else{
  $DEMANDE_ID_SQL='';
  $RETOUR='';
 ...
 <div align="center">
  <table class="table_inc" cellspacing="1" cellpading="0">
    ...
    <tr align="center" class="titre">
     ...
     `changement_status`.`CHANGEMENT_STATUS_ID`,
     `changement_demande`.`CHANGEMENT_DEMANDE_ID`,
     ...
     ORDER BY `changement_demande`.`CHANGEMENT_DEMANDE_LIB`,`changement_mail`.`CHANGEMENT_MAIL_LIB`,`changement_status`.`CHANGEMENT_STATUS`
      ...
      do {
        ...
        <tr align="center" class='.$class.'>
          ...
          <td align="left"><a class="LinkDef" href=./index.php?ITEM=changement_Gestion_Mail&STATUS_ID='.$CHANGEMENT_STATUS_ID.'&DEMANDE_ID='.$CHANGEMENT_DEMANDE_ID.'>&nbsp;'.stripslashes($CHANGEMENT_STATUS ).'&nbsp;</a></td>
    ...
    echo '
    <tr align="center" class="titre">
      <td align="center" colspan="3"><b>&nbsp;'.$RETOUR.'&nbsp;</b></td>
    </tr>
  </table>
</div>
';
