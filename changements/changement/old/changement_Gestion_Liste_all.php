...
<table class="table_inc">
  <!--<tr align="center" class="titre">
    <td align="center" colspan="12"><h2>&nbsp;[&nbsp;<a href="#Bas_de_page">Fin</a>&nbsp;]&nbsp;</h2></td>
  </tr>-->
  <tr align="center" class="titre">
    <td align="center" colspan="12"><h2>&nbsp;Liste de l\'ensemble des changements&nbsp;</h2></td>
  </tr>
  ';
     if($NB_ALL>$Var_max_resultat_page_limit){
     	//./index.php?ITEM=changement_Gestion_Liste_all
     	$var_url="./index.php?ITEM=changement_Gestion_Liste_all&order=".$order;
     	echo '
  <tr align="center" class="titre">
	...
	mysql_free_result($res_rq_info_id);
            ...
            echo '
              <tr align="center" class="titre">
                ...
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=iddesc">&#9660;</a>
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=id">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Demandeur
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=demandeurdesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=demandeur">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Status
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=statusdesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=status">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Type de demande
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=typedesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=type">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Date&nbsp;D&eacute;but
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=debutdesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=debut">&#9650;</a>
                &nbsp;
                </td>
                <td align="center">&nbsp;Heure&nbsp;</BR>&nbsp;D&eacute;but&nbsp;</td>
                <td align="center">&nbsp;Date&nbsp;Fin
                <a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=findesc">&#9660;</a>
		<a class="LinkModif" href="./index.php?ITEM=changement_Gestion_Liste_all&order=fin">&#9650;</a>
                &nbsp;
                </td>
  ...
  <tr align="center" class="titre">
	...
	echo '<tr align="center" class="titre">
         ...
         echo '  
          <tr align="center" class="titre">
            <td align="center" colspan="12">Il n\'y a pas d\'intervention.</td>
          </tr> 
          <tr align="center" class="titre">
            <td align="center" colspan="12">&nbsp;</td>
          </tr>';
		...
		echo '
		<!--<tr align="center" class="titre">
 		  <td align="center" colspan="12"><h2>&nbsp;[&nbsp;<a href="#Haut_de_page">D&eacute;but</a>&nbsp;]&nbsp;</h2></td>
    </tr>-->
		</table>';
