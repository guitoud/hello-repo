 ...
 <div align="center">
  ...
  <table class="table_inc" cellspacing="1" cellpading="0">
    <tr align="center" class="titre">
      <td align="center" colspan="'.$colspan.'">&nbsp;[&nbsp;<a href="./index.php?ITEM=Admin_Gestion_Utilisateurs">Retour</a>&nbsp;]&nbsp; - <a href="./Admin/Admin_Gestion_Utilisateurs_info_csv.php"><img src="./img/logo_excel.png" border="0"/></a></td>
    </tr>
    <tr align="center" class="titre">
      ...
      if($colspan!=3){
      	do {
      		$ROLE=str_replace("-", "&nbsp</BR>&nbsp",$tab_rq_info_role['ROLE']);
    ...
    do {
      ...
      <tr align="center" class='.$class.'>
        <td align="left">&nbsp;'.stripslashes($LOGIN).'&nbsp;</td>
