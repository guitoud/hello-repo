...
function Constitue_corps_Message($MAIL_DEST,$MAIL_OBJET,$MAIL_COMMENTAIRE,$message_debut,$message_FAR,$message_BILAN,$message_signature)
{
	$message  = '';
	$message .='<html>'."\n";
	$message .=header_mess();
...
function Constitue_corps_Message_SVG($Personne_complet,$MAIL_DEST,$MAIL_OBJET,$MAIL_COMMENTAIRE,$message_debut,$message_FAR,$message_BILAN,$message_signature)
{
	$MAIL_A='';
	$MAIL = explode(";", $MAIL_DEST);
	$NB_TOTAL_MAIL=count($MAIL);
