...
<form method="post" name="frm_inter" id="frm_inter" action="./index.php?ITEM='.$_GET['ITEM'].'">
  ...
  $rq_info_id="
   ...
   if($STOP_OUI_NON==1){
	   ...
	   echo '
	   <tr class="'.$class.'">
	    <td align="center" colspan="4"><font color=#993333><b>Merci de saisir l\'ensemble des champs OUI-NON.</b></font>
	    </td>
	   </tr>';
   }
   if($STOP_TEXT==1){
	   ...
	   echo '
	   <tr class="'.$class.'">
	    <td align="center" colspan="4"><font color=#993333><b>Merci de saisir l\'ensemble des champs Commentaires.</b></font>
	    </td>
	   </tr>';
   }
   if($STOP_PERSO==1){
