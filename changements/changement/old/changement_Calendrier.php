	...
	if($total_ligne_rq_changement_info!=0){
		do {
          ...
          ";
					...
					<a href="./index.php?ITEM=changement_Modif_Changement&action=Modif&ID='.$CHANGEMENT_ID.'" class="infobulledroite"><FONT COLOR="#'.$CHANGEMENT_DEMANDE_COULEUR_TEXTE.'">'.$AFF.'</FONT>
					<span>'.$AFF_SPAN.'</span>
					</a>
					</td>';
				}else{
